# Social Square Text-Model Adaptation

## Visual previews
![Repair before](C:\Users\Fedelesh_dm\mvp\dataset\social-square\reports\contact-sheet-square-text-model-before.svg)

![Repair after](C:\Users\Fedelesh_dm\mvp\dataset\social-square\reports\contact-sheet-square-text-model-after.svg)

## What changed in logic
- square repair now includes a constrained text mode for near-miss hero squares
- this mode uses stronger subtitle de-emphasis, tighter block stacking, narrower text width, and headline-dominant fallback when subtitle hurts readability
- thresholds remain unchanged; this pass only changes square text-model behavior
...
### Group 15
- after outcome: pass
- strategy: `square-constrained-text-model`
- bottlenecks: spacing/block-stack inefficiency
...
- suspicious passes created by this repair pass: 5
...
- use this text-model pass only as a square repair improvement, not as a threshold rewrite
